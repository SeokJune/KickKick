                        ...
                        <div class="row h-100">
                            ...
                            <div class="col-xs-12 col-md-8">
                                <div class="row h-100">
                                    ...
                                    <div class="col-12 ">
                                        <input class="w-75" type="text" style="border: 1px solid black;" id="t2"
                                            value="팀장 이름" readonly>
                                    </div>
                                    <div class="col-12">
                                        <input class="w-75" type="text" style="border: 1px solid black;" id="t3"
                                                ...
                                                <div class="option">
                                                    <div>
                                                        <form onsubmit="searchPlaces(); return false;">
                                                            키워드 : <input type="text" value="서울올림픽경기장" id="keyword" size="15">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-md-8">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                            <br>    <input class="w-75" type="text" style="border: 1px solid black;" id="d1"
                                                    value="경기할 날짜를 선택하십시오" readonly>
                                            </div>

                                            <div class="col-12">
                                            <br>    <div class="h-100"> 선택일 <input type="text" id="date"> </div>
                                            </div>

                                            <div class="col-12">
                                                <div class="row " style="display: none;">
                                                    <div class="col-2"> 1 </div>
                                                    <div class="col-2" id="year">  </div>
                                                    <div class="col-2" id="month">  </div>
                                                    <div class="col-2" id="day"> </div>
                                                    <div class="col-2" id="mydate"> </div>
                                                    <div class="col-2">1 </div>
                                                </div>
                                            </div>

                                            <div class="col-12">
                                             <br>   <input class="w-100" type="text" placeholder="경기할 시간 입력하십시오 ex)00시 00분">
                                            </div>
                                            ...
                                            <div class="col-12">
                                                  ...
                                                  <br>      <textarea name="write" style="width: 100%; height: 290px;"
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="row">
                                    <div class="col-2"></div>
                                    <div class="col-10">
                                  <br>      <button type="submit" id="request" style="float: right;">등록</button>  
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                <div class="row">
                                    ...
                                    <div class="col-10">
                                       <br>    <button type="button" style="float: left;">취소</button>    
                                    </div>
                                    <div class="col-2"></div>
