	...
	<div class="container-fluid ">
		...
		<div class="row header">
			...
			<div class="col-xs-12 col-md-3 " id="h4">
				<div class="row h-100 ">
					<div class="col-xs-12 "
						style="align-self: center; border: 1px solid black;">팀명</div>
					<div class="col-xs-12 "
						style="align-self: center; border: 1px solid black;">팀장이름</div>
					<div class="col-xs-12 "
						style="align-self: center; border: 1px solid black;">연락처</div>
				</div>
			</div>
								...
								<div class="option">
									<div>
										<form onsubmit="searchPlaces(); return false;">
											키워드 : <input type="text" value="서울경기장" id="keyword" size="15">
