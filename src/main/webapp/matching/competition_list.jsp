    ...
    <div class="container-fluid">
        ...
        <div class="row header">
            ...
            <div class="col-7" style="height:60px;">
                ...
                <button class="col-3" ><i class="fa-solid fa-magnifying-glass"></i></button>
            </div>
        ...
        <div class="row body">
            ...
            <div class=" col-12 card mb-2 w-100">
                <div class="row g-0">
                    <div class="col-md-4">
                        <img src="/image/competition_img/team_logo.png" class="img-fluid rounded-start">
                    </div>
        ...
        <div class="row footer">
            ...
            <div style="font-size: 25px;" class="col-12" colspan="5" align="center">
