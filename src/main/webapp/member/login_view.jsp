			...
			<div class="container login_container align-self-center">
				<div class="wrapper mx-auto position-relative">
					<div class="position-absolute top-10 end-0 me-5">
						<button type="button" class="btn-close visually-hidden" id="btn_close" aria-label="Close"
						...
						<div class="row d-flex justify-content-center mx-auto p-0 loginForm">
							<div class=" col-md-6 login-form-1">
								...
								<div class="d-md-none d-block d-flex justify-content-end">
									<button type="button" class="btn-close" id="btn_to_back" aria-label="Close"
									...
									<div class="form-group mb-4">
										...
										<div class="form-check float-end">
											<input class="form-check-input" type="checkbox" value="save_id"
												id="save_id"> <label class="form-check-label" for="save_id"
												style="font-size: x-small;">아이디 저장</label>
										</div>
										<input type="text" class="form-control" id="id" name="id" required />
									</div>
									<div class="form-group">
										<label class="control-label font-weight-bold font-size-7pt">비밀번호</label>
										<span>*</span> <input type="password" class="form-control m-0" id="pw" name="pw"
											required />
									</div>
									<div class="form-group mb-4">
							...
							<div class="d-none d-md-block col-md-6 login-form-2 align-self-center" id="hidden">
								...
								<div class="form-group text-center d-flex justify-content-center login_button"
						...
						<div class="row d-flex justify-content-center mx-auto p-0 loginForm">
							<div class="col-md-6 login-form-1 align-center">
								...
								<div class="text-center">
									...
									<label class="btn btn-outline-success" for="btn-check-outlined">휴대폰
										인증하기</label>
								</div>
								<hr>
								<div>
					...
					<!-- 휴대폰 인증하기 누르면 fadeIn -->
					<div class="wrapper_phone_Certification justify-content-center" id="to_phone_authentication_fadeIn"
						style="display: none">
					...
					<!-- 인증하기 누르면 fadeIn -->
					<div class="wrapper_change_pw justify-content-center" id="to_change_pw_fadeIn"
						style="display: none">
						<div class="KickKick_logo text-center d-md-block mb-5">
							<h1 class="mb-4">⚽KickKick</h1>
							<h3 id="search_id"></h3>
						...
						<div class="row d-flex justify-content-center">
							<div class="col-12 col-md-6 mb-1">
								<div class="input-group d-flex">
									<input type="password" class="form-control rounded mt-1" placeholder="새 비밀번호"
										aria-label="password" aria-describedby="password" id="password"
										class="password" />
						...
						<div class="row d-flex justify-content-center">
							<div class="col-12 col-md-6 mt-1">
								<div class="input-group d-flex">
									<input type="password" class="form-control rounded mt-1" placeholder="새 비밀번호"
										aria-label="password" aria-describedby="password_check" id="password_check"
							...
							<div class="row d-flex justify-content-center">
								<div class="col-6 mt-4 mt-xxl-0 w-auto h-auto">
									<div class="alert px-4 py-3 mb-0 alert-warning d-none" role="alert"
										data-mdb-color="warning" id="password-alert">
										<ul class="list-unstyled mb-0">
											<li class="requirements leng"><i class="bi bi-check text-success me-2"></i>
												<i class="bi bi-x text-danger me-3"></i> 암호는 8자 이상이어야 합니다</li>
											<li class="requirements big-letter"><i
												...
												합니다.</li>
											<li class="requirements num"><i class="bi bi-check text-success me-2"></i>
												<i class="bi bi-x text-danger me-3"></i> 암호에 숫자가 하나 이상 포함되어야 합니다.
											</li>
						...
						<div class="row d-flex justify-content-center">
							<div class="col-12 col-md-6 d-flex justify-content-center">
								<button type="button" class="btn btn-outline-success" id="btn_change_pw">비밀번호
									변경하기</button>
							</div>
						</div>
					</div>
