            ...
            <div class="row d-flex justify-content-center">
                <div class="col">
                    <div class="row label">
                        ...
                        <div class="col">
                            <span class="essential">*</span><label class="condition">은 필수로 입력해주세요.</label>
                        </div>
                    </div>
                    <!-- 아이디 -->
                            ...
                            <div class="row input">
                                <div class="col md-9">
                                    <input type="text" class="form-control" id="member_id" name="member_id"
                                        pattern="^[a-z](?=.*[0-9])[0-9a-z]{4,19}$" maxlength="20" required>
                                </div>
                            </div>
                            <!-- 아이디 중복확인 메세지 -->
                    ...
                    <div class="row insert">
                        <div class="row insert">
                            <div class="col-md-6 col-sm-8">
                                ...
                                <div class="row input">
                                    <input type="password" class="form-control rounded" aria-label="password"
                            ...
                            <div class="col-10 mt-xxl-0 w-auto h-auto">
                                <div class="alert px-4 py-3 mb-0 d-none " role="alert" data-mdb-color="warning"
                                    ...
                                    <ul class="list-unstyled mb-0">
                                        <li class="requirements leng"><i class="bi bi-check text-success me-2"></i> <i
                                        ...
                                        <li class="requirements big-letter"><i
                                            ...
                                            합니다.</li>
                                        <li class="requirements num"><i class="bi bi-check text-success me-2"></i> <i
                                                class="bi bi-x text-danger me-3"></i> 암호에 숫자가 하나 이상 포함되어야 합니다.
                                        </li>
                                        <li class="requirements special-char"><i
                                                class="bi bi-check text-success me-2"></i>
                                            <i class="bi bi-x text-danger me-3"></i> 암호에 특수문자가 하나 이상 포함되어야
                                            합니다.
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="row insert">
                            <div class="col-md-6 col-sm-6">
                                <div class="row input d-flex">
                                    <input type="password" class="form-control rounded mt-1" aria-label="password"
                            ...
                            <div class="row input">
                                <div class="col">
                                    <input type="text" class="form-control" id="member_name" name="member_name"
                                        pattern="^[가-힣]{2,5}$" title="2자 이상 5자 이내의 한글" minlength="2" maxlength="5"
                                        required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6">
                            ...
                            <div class="row input">
                                ...
                                <div class="col-md-4 mt-1 d-flex justify-content-center">
                                    <button type="submit" class="btn btn-outline-success text-wrap" id="phone_auth">인증번호
                                        받기</button>
                                </div>
                            </div>
                            <br>
                        ...
                        <div class="row input ">
                            <div class="col-md-4 col-sm-3 d-flex align-items-center">
                                <select class="form-select m-1" id="member_birth_year"
                                    name="member_birth_year"></select>
                                년
                            </div>
                            <div class="col-md-4 col-sm-3 d-flex align-items-center">
                                <select class="form-select m-1" id="member_birth_month"
                                    name="member_birth_month"></select>
                                월
                            </div>
                            <div class="col-md-4 col-sm-3 d-flex align-items-center">
                                <input type="text" class="form-control m-1" id="member_birth_day"
                                    name="member_birth_day" pattern="^(0[1-9]|[12][0-9]|3[01])$" title="두자리로 입력"
                        ...
                        <div class="row input">
                            <div class="col">
                                <input type="text" class="form-control" id="member_nickname" name="member_nickname"
                                    pattern="^[가-힣a-zA-Z0-9]{2,10}$" title="2자 이상 10자 이내로 한글, 영대소문자, 숫자 중 1개 이상 포함 "
                ...
                <div class="row insert ">
                    <div class="col d-flex justify-content-center mb-4">
                        <div class="row input member_agree ">
                            <div class="col">
                                <span> 가입에 동의하시겠습니까? </span> <input class="form-check-input" type="checkbox"
                                    id="member_agree" name="member_agree" value="Y" required>
                            </div>
                        </div>
                    </div>
                </div>
