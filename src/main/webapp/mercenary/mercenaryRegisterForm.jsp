	...
	<div class="container fluid">
        ...
        <div class="row header2">
            <div class="col-xs-12 col-md-4 col-xl-4 text-center">
                <div>${teamInfodto.team_logo}</div>
            </div>
            <div class="col-xs-12 col-md-8 col-xl-8">
                <div>팀명 <input type="text" value="${teamInfodto.team_name}" readonly></div>
                <div class="box">
                    <div class="col-12 col-md-6 col-xl-6">팀장 <input type="text" id="name" value="${teamInfodto.name}" readonly></div>
                    <div class="col-12 col-md-6 col-xl-6">연락처 <input type="text" value="${teamInfodto.phone}" readonly></div>
                </div>
            </div>
        </div>
        <br>
        <div class="row body1">
            <div class="matchSelect"><button>경기 선택</button></div>
            <div class="box">
