					...
					<div class="offcanvas offcanvas-start flex-shrink-0 p-3" style="width: 280px;" tabindex="-1"
						...
						<div class="profile border-bottom text-center pb-2">
							<a href="/index.jsp" class="nav_a">
								<h5 class="offcanvas-title" id="offcanvasNavbarLabel" style="text-decoration: none;">
									⚽KickKick</h5>
							</a> <img src="/image/login_img/ball_icon.png" alt="Image" class="center-block mb-4"
				...
				<input type="hidden" name="cpage" value="${cpage}">
					...
					<div class="row body">
						...
						<div class="col-12 p-2">
							<input type="text" placeholder="제목" style="width: 100%" name="title" value="${board.title}"
								required>
						</div>
						<div class="col-12 p-2" id="editorBox">
							<textarea id="editor" name="content"
								placeholder="1300자 이내로 작성해주세요">${board.content}</textarea>
						</div>
						<div>
