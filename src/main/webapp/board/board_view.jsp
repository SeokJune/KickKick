		...
		<body>
				...
				<div class="container-fluid">
					...
					<div class="offcanvas-header">
						<a href="/index.jsp" class="nav_a">
							<h5 class="offcanvas-title" id="offcanvasNavbarLabel" style="text-decoration: none;">
								⚽KickKick</h5>
						</a>
					</div>
					<a class="navbar-brand nav_a" href="/member/login_view.jsp">Login</a>

					<div class="offcanvas offcanvas-start flex-shrink-0 p-3" style="width: 280px;" tabindex="-1"
						...
						<div class="profile border-bottom text-center pb-2">
							...
							<img src="/image/login_img/ball_icon.png" alt="Image" class="center-block mb-4"
			...
			<div class="container">
				<div class="row header">
					...
					<div class="col-12">${board.member_nickname} · ${board.calculated_date} · 👀 ${board.view_count} ·
						<span class="badge rounded-pill text-bg-success">👍🏻${board.like_count}</span></div>
				</div>
				<div class="row body">
			...
			<script>
				...
				$("#to_update").on("click", function () {
					location.href = "/to_update_form.board?b_c=${b_c}&code=${board.code}";
				});
