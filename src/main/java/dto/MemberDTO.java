...
public class MemberDTO {
	...
	public MemberDTO(int code, int join_kind_code, String id, String pw, String name, String nick_name,
			String birth_date, String phone, String email, String agree, int authority_grade_code, Timestamp reg_date,
