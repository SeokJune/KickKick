...
public class CompetitionApplicationDTO {
	...
	public CompetitionApplicationDTO(int code, int competition_registration_code, int team_code, int ability_code, String content, int status_code, Timestamp reg_date, Timestamp mod_date, Timestamp del_date) {
		this.code = code;
