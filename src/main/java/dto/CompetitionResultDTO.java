...
public class CompetitionResultDTO {
	...
	public CompetitionResultDTO(int competition_registration_code, int registration_team_code, int registration_team_score, int application_team_code, int application_team_score, Timestamp reg_date, Timestamp mod_date, Timestamp del_date) {
