...
public class BoardDTO {
	...
	public BoardDTO() {}
	public BoardDTO(int code, int board_kind_code, int board_headline_code, int member_code, String title,
			String content, int view_count, int like_count, Timestamp reg_date, Timestamp mod_date,
			Timestamp del_date) {
		super();
		this.code = code;
